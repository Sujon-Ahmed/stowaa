                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a href="{{ route('index') }}" title="Browse Website" target="_blank"
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button"
                                    data-toggle="dropdown">
                                    <img src="{{ asset('dashboard_assets/images/user-avatar.png') }}" width="20"
                                        alt="" />
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('category.trashed') }}">Trash Category</a></li>
                        </ul>
                    </li>
                    {{-- subcategory nav --}}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('orders') }}">Order Details</a></li>
                        </ul>
                    </li>
                    {{-- contact --}}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
