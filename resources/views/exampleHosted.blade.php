    ...
    <div class="row mt-5">
        <div class="col-md-6 m-auto order-md-1">
            ...
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                <span class="text-muted">Your cart Item</span>
                <span class="badge badge-secondary badge-pill">{{App\Models\Cart::where('user_id', Auth::guard('customer')->id())->count()}}</span>
            </h4>
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <span class="text-muted">{{ $delivery_charge }}</span>
                </li>
                ...
                <button class="btn btn-primary btn-sm btn-block" type="submit">Continue to checkout (Hosted)</button>
            </form>
        </div>
    </div>
