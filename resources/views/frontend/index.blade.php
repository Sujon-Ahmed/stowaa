                        ...
                        <div class="product-area clearfix row">
                            ...
                            <div class="grid col-lg-4">
                                <div class="product-pic">
                                    <img src="{{asset('uploads/products/preview')}}/{{$product->product_preview}}" alt>                                   
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="product_details_content">
                                                                ...
                                                                <ul class="default_btns_group ul_li">
                                                                    ...
                                                                    <li class="add_wishlist"><a href=""><i class="fas fa-heart"></i></a></li>
                                                                </ul>
                            ...
                            <div class="vertical_slider_4item" data-slick='{"dots": false}'>
                                ...
                                <div class="slider_item">
                                    <div class="small_product_layout">
                                        <a class="item_image" href="{{route('product.details',$product->id)}}">
                                            <img src="{{asset('/uploads/products/preview')}}/{{$product->product_preview}}" alt="image_not_found">
                                        </a>
                                        <div class="item_content">
                                            <h3 class="item_title">
