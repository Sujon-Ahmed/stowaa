                            ...
                            <div class="product-area shop-grid-product-area clearfix">
                                ...
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{asset('/uploads/products/preview')}}/{{$item->product_preview}}" alt />
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup{{$item->id}}" role="button" tabindex="0">
                                                        <svg
                                                            width="48px"
                                                            height="48px"
                                                            viewBox="0 0 24 24"
                                    ...
                                    <div class="details">
                                        <h4><a href="{{route('product.details',$item->id)}}">{{$item->product_name}}</a></h4>
                                        <p><a href="{{route('product.details',$item->id)}}">{{$item->short_description}}</a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi> <span class="woocommerce-Price-currencySymbol">৳ </span>{{$item->after_discount}}</bdi>
                                                </span>
                                            </ins>
                                            <del aria-hidden="true">
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi> <span class="woocommerce-Price-currencySymbol">৳ </span>{{$item->product_price}}</bdi>
                                                </span>
                                            </del>
                                        </span>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="product_details_content">
                                                                    <h2 class="item_title">{{$item->product_name}}</h2>
                                                                    <p>
                                                                    ...
                                                                    <ul class="default_btns_group ul_li">
                                                                        <li><a class="addtocart_btn" href="{{route('product.details',$item->id)}}">Add To Cart</a></li>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel">
                        <div class="product_layout2_wrap">
                            <div class="product-area-row">
                                    ...
                                    <div class="product-pic">
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup2{{$item->id}}" role="button" tabindex="0">
                                                        <svg
                                                            width="48px"
                                                            height="48px"
                                                            viewBox="0 0 24 24"
                                ...
                                <!-- product quick view modal - start
                                ================================================== -->
                                <div class="modal fade" id="quickview_popup2{{$item->id}}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalToggleLabel2">Product Quick View</h5>
